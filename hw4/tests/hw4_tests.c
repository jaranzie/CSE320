...
Test(demo_master_suite, master_startup_test) {
    char *cmd = "bin/polya";
    int return_code = WEXITSTATUS(system(cmd));
...
Test(demo_master_suite, master_trivial_test) {
...
Test(demo_master_suite, master_miner_test_one_worker) {
...
Test(demo_master_suite, master_miner_test_three_workers) {
